...
def get_initial_mole_fractions_and_state(
    path: str, T: Union[float, np.ndarray], P: Union[float, np.ndarray],
...
def get_dYdt(P: Union[float, np.ndarray], R: float, gas_info: GasInfo,
             nasa_poly: NASAPolynomials, kinetics_coeffs: KineticsCoeffs,
             kinetics_data: KineticsData, t: Union[float, np.ndarray],
  ...
  mean_molecular_weight = get_mean_molecular_weight(Y,
                                                    gas_info.molecular_weights)
